...
function sp = sp_evaluate_col_scal (space, msh, varargin)
...
if element_mask_enabled
  sp = sp_evaluate_col_param_scal (space, msh, 'value', value_param, 'gradient', grad_param, 'hessian', hessian_param, 'element_mask', element_mask);
else
  sp = sp_evaluate_col_param_scal (space, msh, 'value', value_param, 'gradient', grad_param, 'hessian', hessian_param);
end
