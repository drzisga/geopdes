...
function sp = sp_evaluate_col_vec (space, msh, varargin)
...
if element_mask_enabled
  sp = sp_evaluate_col_param_vec (space, msh, 'value', value_param, 'gradient', grad_param, 'divergence', div_param, 'curl', curl_param, 'hessian', hessian, 'element_mask', element_mask);
else
  sp = sp_evaluate_col_param_vec (space, msh, 'value', value_param, 'gradient', grad_param, 'divergence', div_param, 'curl', curl_param, 'hessian', hessian);
end
