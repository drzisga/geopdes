...
function [cell_indices, indices_per_function] = sp_get_cells_vec (space, msh, fun_indices)
...
for icomp = 1:space.ncomp_param
  ...
  [cells, ind_per_fun] = sp_get_cells_scal (space.scalar_spaces{icomp}, msh, indices);
